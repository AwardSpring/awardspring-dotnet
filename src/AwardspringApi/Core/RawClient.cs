...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal async global::System.Threading.Tasks.Task<global::AwardspringApi.Core.ApiResponse> SendRequestAsync(
        global::AwardspringApi.Core.BaseRequest request,
    ...
    /// </summary>
    private async global::System.Threading.Tasks.Task<global::AwardspringApi.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    )
    {
        ...
        if (!isRetryableContent || maxRetries == 0)
        {
            var response = await httpClient
                ...
                .ConfigureAwait(false);
            return new global::AwardspringApi.Core.ApiResponse
            {
    ...
    private string BuildUrl(global::AwardspringApi.Core.BaseRequest request)
    {
