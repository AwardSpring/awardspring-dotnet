...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal async global::System.Threading.Tasks.Task<global::AwardSpring.Net.Core.ApiResponse> SendRequestAsync(
        global::AwardSpring.Net.Core.BaseRequest request,
    ...
    /// </summary>
    private async global::System.Threading.Tasks.Task<global::AwardSpring.Net.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    )
    {
        ...
        if (!isRetryableContent || maxRetries == 0)
        {
            var response = await httpClient
                ...
                .ConfigureAwait(false);
            return new global::AwardSpring.Net.Core.ApiResponse
            {
    ...
    private string BuildUrl(global::AwardSpring.Net.Core.BaseRequest request)
    {
