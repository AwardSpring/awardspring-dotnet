...
public partial class AwardsClient : IAwardsClient
{
    ...
    internal AwardsClient(RawClient client)
    {
        _client = client;
    }

    private async Task<WithRawResponse<AwardV1ListResponse>> ListAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<AwardV1ListResponse>(responseBody)!;
                return new WithRawResponse<AwardV1ListResponse>()
                {
                    Data = responseData,
    ...
    /// </code></example>
    public WithRawResponseTask<AwardV1ListResponse> ListAsync(
        ListAwardsRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<AwardV1ListResponse>(
